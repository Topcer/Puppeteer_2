Feature: TheCinema test
    ...
    Scenario: Should book  3 ticket
        ...
        When user choose seats row "2" and seat "7"
        When user choose seats row "2" and seat "8"
        When user choose seats row "2" and seat "9"
        When user click book "button"
        Then user sees booking confirmation "Вы выбрали билеты:"
    ...
    Scenario: Should't book ticket
        ...
        When user choose movie "3" and movieTime "3"
        Then user sees the header "Унесенные ветром"
